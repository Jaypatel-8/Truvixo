...
export const ourWorkData = {
  ...
  industries: [
    ...
    { name: 'Healthcare', iconName: 'Phone', color: '#c91a6f' },
    { name: 'Retail', iconName: 'ShoppingCart', color: '#fecc4d' },
    { name: 'Logistics', iconName: 'Globe', color: '#10b981' },
    { name: 'Real Estate', iconName: 'Building2', color: '#5e2cb6' },
    { name: 'Education', iconName: 'Code', color: '#c91a6f' }
  ],
  benefits: [
    {
      iconName: 'Zap',
