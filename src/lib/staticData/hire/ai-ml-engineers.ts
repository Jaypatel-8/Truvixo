// Server-only static data for Hire AI/ML Engineers page
export const aiMlEngineersData = {
  hero: {
    badge: {
      iconName: 'Brain',
  ...
  processSteps: [
    ...
    },
    {
      ...
      description: 'We match you with AI/ML engineers skilled in your domain',
      iconName: 'Users'
    },
    {
