// Server-only static data for Hire Mobile Developers page
export const mobileDevelopersData = {
  hero: {
    badge: {
      iconName: 'Smartphone',
  ...
  processSteps: [
    {
      ...
      description: 'We analyze your mobile app requirements and platform preferences',
      iconName: 'Target'
    },
    {
    ...
    },
    {
      ...
      description: 'Comprehensive interviews covering mobile development and frameworks',
      iconName: 'FileText'
    },
    {
