// Comprehensive Technology SEO Content for Global Rankings
// Optimized for technology-specific searches worldwide
...
// Technology-specific SEO data
export const technologySEOData: Record<string, TechnologySEO> = {
  'frontend': {
    slug: 'frontend',
    name: 'Frontend Development',
    title: 'Best Frontend Development Company | React, Next.js, Vue, Angular Experts | TruVixo™',
    description: 'Expert frontend development services with React, Next.js, Vue.js, Angular, TypeScript. Build modern, responsive web applications. Global frontend development company.',
    keywords: [
...
Whether you need React.js developers, Next.js experts, Vue.js developers, or Angular developers, TruVixoo delivers custom frontend solutions tailored to your business needs. We offer frontend consulting, frontend architecture design, and ongoing frontend development support.`,
  ...
  'backend': {
    ...
    title: 'Best Backend Development Company | Node.js, Python, Django, FastAPI Experts | TruVixo™',
    description: 'Expert backend development services with Node.js, Python, Django, FastAPI, NestJS. Build scalable APIs, microservices, and server-side applications. Global backend development company.',
    keywords: [
...
Whether you need Node.js developers, Python developers, Django developers, or FastAPI experts, TruVixoo delivers custom backend solutions tailored to your business needs. We offer backend consulting, backend architecture design, and ongoing backend development support.`,
  ...
  'mobile': {
    ...
    title: 'Best Mobile App Development Company | React Native, Flutter, iOS, Android Experts | TruVixo™',
    description: 'Expert mobile app development services with React Native, Flutter, iOS, Android. Build native and cross-platform mobile applications. Global mobile app development company.',
    keywords: [
...
Whether you need React Native developers, Flutter developers, iOS developers, or Android developers, TruVixoo delivers custom mobile solutions tailored to your business needs. We offer mobile app consulting, mobile app architecture design, and ongoing mobile app development support.`,
  ...
  'ai-ml': {
    ...
    title: 'Best AI & Machine Learning Development Company | TensorFlow, PyTorch, LLM Experts | TruVixo™',
    description: 'Expert AI and machine learning development services with TensorFlow, PyTorch, OpenAI, LLM integration. Build intelligent AI solutions and ML models. Global AI development company.',
    keywords: [
...
Whether you need TensorFlow developers, PyTorch developers, AI consultants, or LLM integration experts, TruVixoo delivers custom AI solutions tailored to your business needs. We offer AI consulting, ML model development, and ongoing AI development support.`,
  ...
  'cloud-devops': {
    slug: 'cloud-devops',
    name: 'Cloud & DevOps',
    title: 'Best Cloud & DevOps Services Company | AWS, Azure, Docker, Kubernetes Experts | TruVixo™',
    description: 'Expert cloud and DevOps services with AWS, Azure, GCP, Docker, Kubernetes. Build scalable cloud infrastructure and CI/CD pipelines. Global cloud DevOps company.',
    keywords: [
      ...
      'best cloud developers',
      'hire DevOps engineers',
      'cloud development services',
      'custom cloud solutions',
      'enterprise cloud development',
      'cloud development agency',
...
Whether you need AWS developers, Azure developers, Docker experts, or Kubernetes engineers, TruVixoo delivers custom cloud solutions tailored to your business needs. We offer cloud consulting, DevOps automation, and ongoing cloud infrastructure support.`,
  ...
  'database': {
    ...
    title: 'Best Database Development Company | MongoDB, PostgreSQL, MySQL Experts | TruVixo™',
    description: 'Expert database development services with MongoDB, PostgreSQL, MySQL, Redis. Design and optimize database solutions. Global database development company.',
    keywords: [
...
Whether you need MongoDB developers, PostgreSQL developers, MySQL developers, or database consultants, TruVixoo delivers custom database solutions tailored to your business needs. We offer database consulting, database migration services, and ongoing database administration support.`,
  ...
  'tools-integrations': {
    ...
    title: 'Best Development Tools & Integration Services | API Integration, Third-Party Tools | TruVixo™',
    description: 'Expert tools and integration services. API development, third-party integrations, development tools setup. Global integration services company.',
    keywords: [
...
// Generate technology page metadata
export function getTechnologyMetadata(slug: string) {
  const tech = technologySEOData[slug]
  if (!tech) {
    return {
      title: 'Technology Services | TruVixo™',
      description: 'Expert technology development services. Build modern applications with cutting-edge technologies.',
      keywords: ['technology services', 'development services', 'software development']
    }
  }
...
// Generate technology page content
export function getTechnologyContent(slug: string) {
  return technologySEOData[slug] || null
}
