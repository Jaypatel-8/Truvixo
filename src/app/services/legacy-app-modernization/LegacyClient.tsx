...
export default function LegacyClient({ faqs, legacyData }: LegacyClientProps) {
  ...
  const industries = useMemo(() => 
    (legacyData.industries || []).map(industry => {
      const IconComponent = getIcon(industry.iconName)
      return {
        ...industry,
        icon: IconComponent ? <IconComponent className="w-7 h-7" strokeWidth={2} /> : null
      }
    }), [legacyData.industries]
  )

  const benefits = useMemo(() => 
    legacyData.benefits.map(benefit => {
  ...
  const previewServices = useMemo(() => 
    legacyData.services.slice(0, 4).map(service => {
      const IconComponent = getIcon(service.iconName)
      return {
        ...service,
        icon: IconComponent ? <IconComponent className="w-8 h-8" strokeWidth={2} /> : null
  ...
  return (
    <>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover how legacy app modernization can transform outdated systems into modern solutions
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore how businesses leverage legacy app modernization to transform outdated systems
            </p>
          </div>
      ...
      />
      <RelatedLinks title="Related Services" links={getServiceRelatedLinks('legacy-app-modernization')} columns={3} />
      <ContactFormModal 
