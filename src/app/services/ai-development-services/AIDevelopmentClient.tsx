...
interface AIDevelopmentClientProps {
...
export default function AIDevelopmentClient({ faqs }: AIDevelopmentClientProps) {
  ...
  const technologies = [
    ...
    { name: 'OpenAI API', logo: 'https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@v9/icons/openai.svg', color: '#10A37F', category: 'backend' as const }
  ]
