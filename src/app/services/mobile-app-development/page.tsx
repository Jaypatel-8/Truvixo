...
export default function MobileAppDevelopment() {
  ...
  const technologies = [
    ...
    { name: 'App Store Connect', logo: 'https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@v9/icons/appstore.svg', color: '#007AFF', category: 'mobile' as const },
    { name: 'Google Play Console', logo: 'https://cdn.jsdelivr.net/gh/simple-icons/simple-icons@v9/icons/googleplay.svg', color: '#4285F4', category: 'mobile' as const }
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="scroll-animate">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-10 font-light">
              Get in touch and let's discuss how we can transform your business with mobile applications.
            </p>
