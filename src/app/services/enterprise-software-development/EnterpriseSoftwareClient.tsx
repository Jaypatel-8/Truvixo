...
interface EnterpriseSoftwareClientProps {
...
export default function EnterpriseSoftwareClient({ faqs }: EnterpriseSoftwareClientProps) {
  ...
  return (
    <main className="min-h-screen bg-gray-50 overflow-hidden">
      ...
      <RelatedLinks title="Related Services" links={getServiceRelatedLinks('enterprise-software-development')} columns={3} />
      <ContactFormModal 
