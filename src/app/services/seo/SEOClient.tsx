...
export default function SEOClient({ faqs, seoData }: SEOClientProps) {
  ...
  useIntersectionObserver({
    ...
    selectors: ['.scroll-animate', '.scroll-animate-left', '.scroll-animate-right', '.scroll-animate-scale', '.scroll-stagger', '.section-reveal', '.section-desc-reveal', '.heading-reveal', '.p-reveal', '.btn-entrance'],
  ...
  return (
    <>
      ...
      <RelatedLinks 
        ...
        links={getServiceRelatedLinks('seo')} 
        columns={3}
      />
      <ContactFormModal 
