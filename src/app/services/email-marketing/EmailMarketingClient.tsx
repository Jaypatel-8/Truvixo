...
export default function EmailMarketingClient({ faqs }: EmailMarketingClientProps) {
  ...
  const services = emailMarketingData.services.map(service => {
  ...
  const whyChooseUs = emailMarketingData.whyChooseUs.map(item => {
  ...
  const processSteps = emailMarketingData.processSteps.map(step => {
  ...
  const industries = emailMarketingData.industries.map(industry => {
  ...
  const benefits = emailMarketingData.benefits.map(benefit => {
  ...
  const previewServices = emailMarketingData.services.slice(0, 4).map(service => {
    const IconComponent = getIcon(service.iconName)
    return {
      ...service,
      icon: IconComponent ? <IconComponent className="w-8 h-8" strokeWidth={2} /> : null
  ...
  const BadgeIcon = getIcon(emailMarketingData.hero.badge.iconName)
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-animate">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#5e2cb6]/10 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold text-[#5e2cb6]">{emailMarketingData.hero.badge.text}</span>
              </div>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
                {emailMarketingData.hero.title}{' '}
                <span className="hollow-text-brand block mt-2">
                  {emailMarketingData.hero.hollowText}
                </span>
              </h1>
              <p className="text-base md:text-lg text-gray-600 mb-8 leading-relaxed">
                {emailMarketingData.hero.description}
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We deliver strategic email marketing campaigns that nurture leads and drive conversions.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Serving diverse industries with email marketing solutions
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover how email marketing can nurture leads and drive conversions
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore how businesses use email marketing to nurture leads and retain customers
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {emailMarketingData.useCases.map((useCase, index) => (
              <div
                key={index}
      ...
      />
      <GetQuoteSection
        title={emailMarketingData.getQuote.title}
        hollowText={emailMarketingData.getQuote.hollowText}
        description={emailMarketingData.getQuote.description}
        primaryCTA={{
          text: 'Call Us',
          onClick: () => setIsContactModalOpen(true)
        }}
