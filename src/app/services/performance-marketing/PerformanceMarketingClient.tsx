...
export default function PerformanceMarketingClient({ faqs, performanceMarketingData }: PerformanceMarketingClientProps) {
  ...
  const services = useMemo(() => 
    performanceMarketingData.services.map(service => {
      const IconComponent = getIcon(service.iconName)
      return {
        ...service,
        icon: IconComponent ? <IconComponent className="w-8 h-8" strokeWidth={2} /> : null
      }
    }), [performanceMarketingData.services]
  )

  const whyChooseUs = useMemo(() => 
    performanceMarketingData.whyChooseUs.map(item => {
      const IconComponent = getIcon(item.iconName)
      return {
        ...item,
        icon: IconComponent ? <IconComponent className="w-7 h-7" strokeWidth={2} /> : null
      }
    }), [performanceMarketingData.whyChooseUs]
  )

  const processSteps = useMemo(() => 
    performanceMarketingData.processSteps.map(step => {
  ...
  const BadgeIcon = getIcon(performanceMarketingData.hero.badge.iconName)
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-animate">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
                {performanceMarketingData.hero.title}{' '}
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {performanceMarketingData.useCases.map((useCase, index) => (
              <div
                key={index}
      ...
      />
      <GetQuoteSection
        title={performanceMarketingData.getQuote.title}
        hollowText={performanceMarketingData.getQuote.hollowText}
      ...
      />
      <RelatedLinks title="Related Services" links={getServiceRelatedLinks('performance-marketing')} columns={3} />
      <ContactFormModal 
