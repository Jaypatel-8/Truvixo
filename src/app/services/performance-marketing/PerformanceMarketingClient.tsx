...
export default function PerformanceMarketingClient({ faqs }: PerformanceMarketingClientProps) {
  ...
  const services = performanceMarketingData.services.map(service => {
  ...
  const whyChooseUs = performanceMarketingData.whyChooseUs.map(item => {
  ...
  const processSteps = performanceMarketingData.processSteps.map(step => {
