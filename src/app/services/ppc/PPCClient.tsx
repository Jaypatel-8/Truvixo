...
interface PPCClientProps {
  ...
  ppcData: BasePageData
}

export default function PPCClient({ faqs, ppcData }: PPCClientProps) {
  ...
  const previewServices = useMemo(() => 
    ppcData.services.slice(0, 4).map(service => {
      const IconComponent = getIcon(service.iconName)
      return {
        ...service,
        icon: IconComponent ? <IconComponent className="w-8 h-8" strokeWidth={2} /> : null
  ...
  return (
    <>
      ...
      <section className="py-20 bg-white section-reveal">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto section-desc-reveal">
              Serving diverse industries with PPC solutions
            </p>
          </div>
      ...
      <RelatedLinks 
        ...
        links={getServiceRelatedLinks('ppc')} 
        columns={3}
      />
      <ContactFormModal 
