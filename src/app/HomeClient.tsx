...
const SEOLocationSection = dynamic(
  () => import("../components/SEOLocationSection"),
  {
    ssr: false,
...
const StatsCounter = dynamic(() => import("../components/StatsCounter"), {
  ...
  loading: () => (
    <div className="text-center p-4">
      <div className="h-10 bg-gray-100 rounded animate-pulse mb-1" />
...
export default function HomeClient({
  ...
  useEffect(() => {
    const run = () => {
      ...
      document
        .querySelectorAll(".above-fold .btn-entrance, .above-fold .p-reveal")
    ...
    <main className="min-h-screen bg-white overflow-hidden">
      ...
      <section className="relative min-h-screen bg-white flex items-center justify-center overflow-hidden pt-20">
        ...
        >
          ...
          <div
            className="hero-blob absolute bottom-[20%] right-[8%] w-[500px] h-[500px] rounded-full bg-[#c91a6f]/6 blur-[100px]"
            style={{ animationDelay: "-4s" }}
          />
          <div
            className="hero-blob absolute top-1/2 left-1/2 w-[300px] h-[300px] rounded-full bg-[#10b981]/5 blur-[60px]"
        ...
        >
          <div
            className="hero-ball w-3 h-3 md:w-4 md:h-4 top-[18%] left-[15%] bg-[#5e2cb6]/40"
            style={{ animationDelay: "0s" }}
          />
          <div
            className="hero-ball w-2 h-2 md:w-3 md:h-3 top-[25%] right-[20%] bg-[#c91a6f]/40"
            style={{ animationDelay: "0.4s" }}
          />
          <div
            className="hero-ball w-4 h-4 md:w-5 md:h-5 bottom-[30%] left-[12%] bg-[#10b981]/35"
            style={{ animationDelay: "0.8s" }}
          />
          <div
            className="hero-ball w-2 h-2 md:w-3 md:h-3 bottom-[25%] right-[18%] bg-[#5e2cb6]/30"
            style={{ animationDelay: "0.2s" }}
          />
          <div
            className="hero-ball w-3 h-3 md:w-4 md:h-4 top-[40%] right-[12%] bg-[#c91a6f]/35"
            style={{ animationDelay: "0.6s" }}
          />
          <div
            className="hero-ball w-2 h-2 md:w-3 md:h-3 top-[55%] left-[20%] bg-[#fecc4d]/40"
            style={{ animationDelay: "0.3s" }}
          />
          <div
            className="hero-ball w-3 h-3 md:w-4 md:h-4 bottom-[40%] right-[25%] bg-[#10b981]/30"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 py-16">
          <div className="scroll-animate above-fold">
            <h1
              className="heading-reveal text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-gray-900 mb-6 leading-[0.9] tracking-tight"
              id="hero-heading"
            >
              <span className="heading-reveal-line block">
                <span>
                  Building the <span className="hollow-text-brand">Future</span>
                </span>
              </span>
              <span className="heading-reveal-line block mt-2 text-2xl md:text-3xl lg:text-4xl font-medium text-gray-600">
                <span>with Intelligent Technology</span>
              </span>
            </h1>

            <p className="p-reveal text-base md:text-lg text-gray-600 max-w-4xl mx-auto font-light leading-relaxed mb-8 px-4">
              We design, build, and scale custom software, AI solutions, and
              digital platforms that transform businesses from concept to market
              leader.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="heading-reveal text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              <span className="heading-reveal-line block">
                <span>
                  Our <span className="hollow-text-brand">Services</span>
                </span>
              </span>
            </h2>
            ...
            <p className="section-desc-reveal text-base text-gray-500 max-w-2xl mx-auto mb-8">
              From custom software development to AI solutions, digital
              marketing, and cloud infrastructure - we deliver end-to-end
              technology services that drive innovation, efficiency, and growth
              for businesses across industries. Our proven methodology combines
              cutting-edge technology with strategic business insights to
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Our <span className="hollow-text-brand">Works</span>
            </h2>
            <p className="section-desc-reveal text-lg text-gray-600 max-w-2xl mx-auto">
              Showcasing excellence in software development, AI solutions, and
              digital innovation across diverse industries and use cases
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="heading-reveal text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              <span className="heading-reveal-line block">
                <span>
                  Why Choose <span className="hollow-text-brand">TruVixoo</span>
                </span>
              </span>
            </h2>
            <p className="section-desc-reveal text-lg text-gray-600 max-w-3xl mx-auto">
              We combine technical expertise with business acumen to deliver
              software solutions that drive real results. Our approach
              integrates industry best practices, modern technology stacks, and
              strategic thinking to create solutions that not only meet current
              needs but scale with your business growth.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="card-inner-reveal">
                    <div
                      className="card-icon mb-3 flex justify-center"
                      style={{ color: color }}
                    >
                      {item.icon}
                    </div>
                    <h3 className="card-title font-semibold text-gray-900 text-sm">
                      {item.title}
                    </h3>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Industries We <span className="hollow-text-brand">Serve</span>
            </h2>
            <p className="section-desc-reveal text-lg text-gray-600 max-w-3xl mx-auto">
              Specialized software solutions tailored to your industry's unique
              challenges. Expert custom development for FinTech, Healthcare,
              E-commerce, Logistics, Real Estate, Education, Manufacturing, and
              Retail sectors. We understand industry-specific requirements and
              deliver solutions that comply with regulations while driving
              business value.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 card-grid-direction">
            {[
              ...
              },
              {
                ...
                color: "#10b981",
                description: "Supply chain systems",
              },
              {
                name: "Real Estate",
              ...
              >
                <div className="card-inner-reveal">
                  <div
                    className="card-icon mb-4 flex justify-center"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Our <span className="hollow-text-brand">Achievements</span>
            </h2>
            <p className="section-desc-reveal text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Our <span className="hollow-text-brand">Expertise</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Deep technical knowledge in full-stack development, AI & machine
              learning, cloud infrastructure, and mobile applications. Our team
              stays current with emerging technologies and industry trends to
              deliver solutions that leverage the latest innovations while
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                title: "Cloud & DevOps",
                description:
                  "Enterprise-grade cloud infrastructure and DevOps practices designed for scalability, reliability, and performance. We implement automated CI/CD pipelines, containerization strategies, and infrastructure as code to ensure your applications are always available, secure, and can scale seamlessly with your business growth.",
              ...
              },
              {
                ...
                description:
                  "Native and cross-platform mobile application development for iOS and Android platforms. We create engaging, high-performance mobile experiences that users love, combining intuitive design with powerful functionality. Our mobile solutions are optimized for performance, security, and seamless user experience across all devices.",
              ...
              },
              {
                title: "UI/UX Design",
                description:
                  "User-centered design solutions that combine aesthetic appeal with functional excellence. We create intuitive, engaging interfaces that not only look beautiful but also drive user engagement and conversions. Our design process includes comprehensive user research, wireframing, prototyping, and usability testing to ensure exceptional user experiences.",
                  ...
                  <div className="mb-6 flex items-center gap-4">
                    <div
                      ...
                      style={{
                        ...
                        backgroundColor: expertise.color + "10",
                      }}
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="heading-reveal text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              <span className="heading-reveal-line block">
                <span>
                  What Our <span className="hollow-text-brand">Clients</span>{" "}
                  Say
                </span>
              </span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              helped transform through innovative software solutions, digital
              marketing strategies, and technology consulting. Our clients span
              various industries and have achieved significant growth and
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Trusted <span className="hollow-text-brand">Partners</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We partner with leading technology platforms and tools including
              Microsoft Azure, Google Cloud, Docker, Kubernetes, and modern
              development frameworks to deliver best-in-class software
              solutions. Our expertise with these platforms ensures scalable,
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Our <span className="hollow-text-brand">Values</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              The core principles that guide everything we do and shape how we
              work with our clients. Our values of innovation, transparency,
              excellence, and client-centricity drive our commitment to
              delivering exceptional software development and digital marketing
            ...
            {[
              {
                ...
                description:
                  "We stay ahead of technology trends and continuously explore new solutions to solve complex problems.",
              ...
              },
              {
                ...
                description:
                  "Your success is our success. We prioritize understanding your business goals and delivering solutions that drive real value.",
                icon: <Users className="w-8 h-8" strokeWidth={2} />,
                color: "#c91a6f",
              },
              {
                title: "Transparency",
                description:
                  "Clear communication, honest feedback, and regular updates ensure you always know where your project stands.",
              ...
              },
              {
                title: "Excellence",
                description:
                  "We maintain the highest standards in code quality, design, and delivery to ensure exceptional outcomes every time.",
                icon: <Award className="w-8 h-8" strokeWidth={2} />,
                color: "#10b981",
              },
            ].map((value, index) => (
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 section-reveal">
          <div className="text-center mb-12 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              services, digital marketing solutions, project process, pricing,
              and how we collaborate with clients to deliver exceptional
              results. Learn more about our expertise, methodologies, and
