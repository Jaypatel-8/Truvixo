...
import { GraduationCap, Book, Users, Video, Target, TrendingUp, Building2, Heart, ShoppingCart, Truck, Home, Code, Rocket, CheckCircle, FileText, Shield, ArrowRight, Phone, Mail, Calendar } from 'lucide-react'
...
export default function EducationDevelopment() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="scroll-animate">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#5e2cb6]/10 rounded-full mb-6">
                <GraduationCap className="w-4 h-4 text-[#5e2cb6]" strokeWidth={2} />
                <span className="text-sm font-semibold text-[#5e2cb6]">Education Solutions</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive education technology solutions tailored to your needs
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We deliver comprehensive education solutions that enhance learning experiences and drive educational excellence.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Serving diverse education segments with tailored solutions
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="scroll-animate">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-10 font-light">
              Get in touch and let's discuss how we can help transform education delivery.
            </p>
      ...
      {/* 8. Process Diagram */}
      <ProcessDiagram
        title="Education Development Process"
        subtitle="From discovery to launch, we ensure engaging learning experiences and educational excellence at every step"
        steps={processSteps}
      />
      ...
      <ContactSection 
        title="Get in Touch"
        description="Have questions about education development? Let's discuss your project."
      />
