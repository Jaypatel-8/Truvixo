        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="scroll-animate">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-4xl mx-auto font-light">
              Tailored technology solutions for the {pageName.toLowerCase()} industry
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="scroll-animate">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                We specialize in delivering technology solutions tailored to the {pageName.toLowerCase()} industry. 
                Our expertise helps businesses in this sector innovate and grow.
              </p>
            </div>
          </div>
        </div>
