...
import { Building2, CreditCard, Wallet, DollarSign, BarChart, TrendingUp, Shield, Zap, Heart, ShoppingCart, Truck, Home, GraduationCap, Target, FileText, Code, Rocket, Settings, CheckCircle, ArrowRight, Phone, Mail, Calendar } from 'lucide-react'
...
export default function FintechDevelopment() {
  ...
  const industries = [
    ...
    { name: 'Lending', icon: <DollarSign className="w-7 h-7" strokeWidth={2} />, color: '#d97706' },
    { name: 'Investments', icon: <BarChart className="w-7 h-7" strokeWidth={2} />, color: '#059669' },
  ...
  return (
    <main className="min-h-screen bg-gray-50 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="scroll-animate">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#5e2cb6]/10 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold text-[#5e2cb6]">Fintech Solutions</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
                We build secure, compliant fintech solutions that transform financial services. From digital banking to payment apps, we deliver enterprise-grade fintech applications.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Comprehensive fintech technology solutions tailored to your needs
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We deliver secure, compliant fintech solutions that transform financial services and drive innovation.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Serving diverse fintech segments with tailored solutions
            </p>
          </div>
      ...
      {/* 7. Process Diagram */}
      <ProcessDiagram
        title="Fintech Development Process"
        subtitle="From discovery to launch, we ensure security, compliance, and scalability at every step"
        steps={processSteps}
      />
      ...
      <ContactSection 
        title="Get in Touch"
        description="Have questions about fintech development? Let's discuss your project."
      />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="scroll-animate">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-10 font-light">
              Get in touch and let's discuss how we can help transform your fintech business.
            </p>
