...
interface FintechClientProps {
  faqs: Array<{ question: string; answer: string }>
}

export default function FintechClient({ faqs }: FintechClientProps) {
  ...
  const services = fintechData.services.map(service => {
  ...
  const whyChooseUs = fintechData.whyChooseUs.map(item => {
  ...
  const processSteps = fintechData.processSteps.map(step => {
  ...
  const industries = fintechData.industries.map(industry => {
  ...
  const benefits = fintechData.benefits.map((benefit: typeof fintechData.benefits[number]) => {
  ...
  const previewServices = fintechData.services.slice(0, 4).map(service => {
    const IconComponent = getIcon(service.iconName)
    return {
      ...service,
      icon: IconComponent ? <IconComponent className="w-8 h-8" strokeWidth={2} /> : null
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover how fintech solutions can transform financial services
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore how businesses leverage fintech solutions to transform financial services
            </p>
          </div>
