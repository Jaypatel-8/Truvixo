...
import { ShoppingCart, Store, Package, TrendingUp, Zap, Target, Building2, Heart, Truck, Home, GraduationCap, Code, Rocket, CheckCircle, FileText, Shield, ArrowRight, Phone, Mail, Calendar } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="scroll-animate">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#5e2cb6]/10 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold text-[#5e2cb6]">Retail & E-commerce Solutions</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
                We build scalable e-commerce platforms and retail solutions that drive sales. From marketplaces to inventory management, we deliver retail technology that grows your business.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="scroll-animate">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-10 font-light">
              Get in touch and let's discuss how we can help transform your retail business.
            </p>
