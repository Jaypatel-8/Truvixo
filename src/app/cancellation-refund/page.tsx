...
export const metadata: Metadata = {
  ...
  description:
    "TruVixoo Cancellation and Refund Policy - Learn about our cancellation procedures, refund eligibility, and terms for services and subscriptions.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <section className="relative py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 scroll-animate">
            <h1 className="text-5xl md:text-6xl font-black text-gray-900 mb-6">
              Cancellation and{" "}
              <span className="hollow-text-brand">Refund Policy</span>
            </h1>
            <p className="text-lg text-gray-600 mb-4">
              Last Updated: {lastUpdated}
            </p>
            <p className="text-xl text-gray-700 leading-relaxed">
              At TruVixo, we strive to provide exceptional services and ensure
              customer satisfaction. This policy outlines our procedures for
              cancellation and refunds for our services.
            </p>
          </div>
        </section>
            ...
            <div className="prose prose-lg max-w-none scroll-animate">
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  You may cancel your service agreement with TruVixoo at any
                  time by providing written notice to our team. Cancellation
                  requests should be sent to{" "}
                  <a
                    href="mailto:support@truvixoo.com"
                    className="text-[#5e2cb6] hover:underline"
                  >
                    support@truvixoo.com
                  </a>{" "}
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  <li>
                    <strong>One-time Projects:</strong> Cancellation must be
                    requested before project completion. Work completed up to
                    the cancellation date will be billed.
                  </li>
                  <li>
                    <strong>Recurring Services (SEO, PPC, SMM):</strong> 30 days
                    written notice required. Services will continue until the
                    end of the current billing cycle.
                  </li>
                  <li>
                    <strong>Monthly Subscriptions:</strong> Cancellation
                    effective at the end of the current billing period.
                  </li>
                  <li>
                    <strong>Dedicated Teams/Hire Services:</strong> 30 days
                    notice required. Ongoing work will be completed during the
                    notice period.
                  </li>
                </ul>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  TruVixoo reserves the right to immediately cancel services in
                  cases of:
                </p>
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Refunds are considered on a case-by-case basis and are subject
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  ...
                  <li>
                    Services must not have been substantially delivered or
                    completed
                  </li>
                  <li>
                    No refunds for completed projects or delivered services
                  </li>
                  <li>
                    Refunds are not available for services that have been
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  ...
                  <li>
                    Services that have been customized or personalized for your
                    specific needs
                  </li>
                  <li>Consultation fees for completed sessions</li>
                  <li>
                    Services cancelled after the cancellation notice period
                  </li>
                </ul>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  In cases where services are partially completed, we may offer
                  partial refunds based on:
                </p>
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Partial refunds will be calculated on a pro-rata basis, minus
              ...
              <div className="mb-12">
                ...
                <ol className="list-decimal list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  ...
                  <li>
                    Include your order number, invoice number, or service
                    agreement reference
                  </li>
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  <li>
                    Cancellation before project kickoff: Full refund minus any
                    setup costs
                  </li>
                  <li>
                    Cancellation during development: Refund for unused portion,
                    minus work completed
                  </li>
                  <li>No refunds after project completion and delivery</li>
                  <li>
                    Source code and deliverables remain with TruVixoo until full
                    payment is received
                  </li>
                </ul>
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  <li>
                    No refunds for services already rendered in the current
                    billing cycle
                  </li>
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  ...
                  <li>
                    Refunds only available if session is cancelled before it
                    begins
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  ...
                  <li>
                    Request mediation or arbitration as outlined in your service
                    agreement
                  </li>
                </ul>
                <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  TruVixoo reserves the right to modify this Cancellation and
                  Refund Policy at any time. Changes will be effective
                  immediately upon posting on this page. We will notify existing
                  clients of significant changes via email.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <div className="bg-gray-50 rounded-xl p-6 mt-6">
                  ...
                  <p className="text-gray-700">
                    <strong>Address:</strong> Global Services
                  </p>
                </div>
              </div>
            </div>
