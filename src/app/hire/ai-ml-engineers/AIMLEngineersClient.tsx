...
export default function AIMLEngineersClient({ faqs, aiMlEngineersData }: AIMLEngineersClientProps) {
  const hero = aiMlEngineersData?.hero
  const badge = hero?.badge
  const BadgeIcon = getIconComponent(badge?.iconName || 'Code') || Code
  ...
  const technologiesList = Array.isArray(aiMlEngineersData?.technologies) ? [...aiMlEngineersData.technologies] : []
