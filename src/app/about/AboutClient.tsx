    ...
    <main className="min-h-screen bg-gray-50 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-animate">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#5e2cb6]/10 rounded-full mb-6">
                ...
                <span className="text-sm font-semibold text-[#5e2cb6]">
                  About TruVixo
                </span>
              </div>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
                About{" "}
                <span className="hollow-text-brand block mt-2">TruVixo</span>
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
                Driven by innovation, powered by technology, and committed to
                excellence. We serve clients worldwide. We deliver comprehensive
                solutions across multiple domains — not just digital marketing.
                We're your end-to-end growth partner, leveraging AI and
                cutting-edge technology to transform businesses from concept to
                market leader.
              </p>
              ...
              {whyChooseUs.slice(0, 4).map((item, index) => (
                ...
                >
                  <div className="card-inner-reveal">
                    ...
                    <h3 className="card-title font-bold text-gray-900 text-sm mb-2">
                      {item.title}
                    </h3>
                    <p className="card-desc text-xs text-gray-600 line-clamp-2">
                      {item.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              What We <span className="hollow-text-brand">Do</span>
            </h2>
            ...
            {focusAreas.map((area, index) => (
              <div
                ...
                style={{
                  ...
                  ["--card-accent" as string]: area.color,
                }}
              >
                <div
                ...
                <div className="card-inner-reveal relative z-10">
                  <div
                    className="card-icon mb-6 flex justify-center"
                  ...
                  <p className="card-desc text-gray-600 text-sm leading-relaxed">
                    Comprehensive {area.name.toLowerCase()} solutions tailored
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Why Choose <span className="hollow-text-brand">TruVixo</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We combine human creativity with AI intelligence to deliver
              exceptional results
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Meet Our <span className="hollow-text-brand">Founders</span>
            </h2>
          </div>
              ...
              <div className="group bg-white rounded-2xl p-8 md:p-12 border-2 border-[#5e2cb6]/40 hover:border-[#5e2cb6] transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-xl text-[#5e2cb6] font-semibold mb-4">
                      Co-Founder
                    </p>
                  </div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    "I co-founded TruVixoo with a vision to democratize
                    AI-powered growth for businesses of all sizes. Having spent
                    over a decade in the tech industry, I've seen too many
                    companies struggle with outdated approaches to growth and
                    innovation."
                  </p>
                </div>
              </div>
              <div className="group bg-white rounded-2xl p-8 md:p-12 border-2 border-[#c91a6f]/40 hover:border-[#c91a6f] transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-xl text-[#c91a6f] font-semibold mb-4">
                      Co-Founder
                    </p>
                  </div>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    "Our mission is to bridge the gap between human creativity
                    and AI intelligence, creating solutions that not only work
                    but evolve with your business. We're not just service
                    providers – we're your partners in transformation."
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              Industries We{" "}
              <span className="hollow-text-brand">Specialize</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover how our comprehensive solutions can transform your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 card-grid-direction">
            ...
            >
              <div className="card-inner-reveal">
                ...
                <p className="card-desc text-gray-600">
                  Leverage cutting-edge AI and machine learning to automate
                  processes, gain insights, and stay ahead of the competition.
                  Our AI solutions adapt and evolve with your business needs.
                </p>
              </div>
            </div>
            ...
            <div
              className="scroll-animate-scale card-hover card-hover-dark bg-white rounded-xl p-8 border border-gray-200 relative overflow-hidden"
              style={{ ["--card-accent" as string]: "#c91a6f" }}
            >
              <div className="card-inner-reveal">
                ...
                <p className="card-desc text-gray-600">
                  From branding and marketing to software development and
                  funding, we're your complete growth partner. One team,
                  multiple services, seamless execution.
                </p>
              </div>
            </div>
            ...
            <div
              className="scroll-animate-scale card-hover card-hover-dark bg-white rounded-xl p-8 border border-gray-200 relative overflow-hidden"
              style={{ ["--card-accent" as string]: "#fecc4d" }}
            >
              <div className="card-inner-reveal">
                ...
                <p className="card-desc text-gray-600">
                  ...
                  We've helped businesses across industries achieve remarkable
            ...
            <div
              className="scroll-animate-scale card-hover card-hover-dark bg-white rounded-xl p-8 border border-gray-200 relative overflow-hidden"
              style={{ ["--card-accent" as string]: "#10b981" }}
            >
              <div className="card-inner-reveal">
                ...
                <p className="card-desc text-gray-600">
                  We build for tomorrow, ensuring your business stays ahead of
                  the curve. Scalable, adaptable solutions that grow with your
                  business and evolve with technology.
                </p>
              </div>
            </div>
            ...
            >
              <div className="card-inner-reveal">
                ...
                <p className="card-desc text-gray-600">
                  Serving clients worldwide. Global expertise with international
                  standards.
                </p>
              </div>
            </div>
            ...
            >
              <div className="card-inner-reveal">
                ...
                <p className="card-desc text-gray-600">
                  Skilled professionals with deep expertise in AI, software
                  development, digital marketing, and business strategy. Your
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-4">
              How We Help <span className="hollow-text-brand">Businesses</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Explore how businesses leverage our solutions to achieve their
              goals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-[#5e2cb6]/5 to-[#c91a6f]/5 rounded-xl p-8 border border-[#5e2cb6]/20">
              ...
              <p className="text-gray-600 mb-4">
                Transform legacy systems into modern, scalable solutions. We
                help businesses modernize their technology stack, improve
                efficiency, and enable digital-first operations.
              </p>
            ...
            <div className="bg-gradient-to-br from-[#fecc4d]/5 to-[#10b981]/5 rounded-xl p-8 border border-[#fecc4d]/20">
              ...
              <p className="text-gray-600 mb-4">
                Leverage AI to automate processes, gain insights, and make
                data-driven decisions. From chatbots to predictive analytics, we
                build AI solutions that drive results.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
            ...
            <div className="bg-gradient-to-br from-[#10b981]/5 to-[#5e2cb6]/5 rounded-xl p-8 border border-[#10b981]/20">
              ...
              <p className="text-gray-600 mb-4">
                Build strong brand identity and execute data-driven marketing
                campaigns. From brand strategy to digital marketing, we help
        ...
        steps={[
          {
            ...
            description:
              "Understand your business goals, challenges, and opportunities to create a comprehensive strategy",
            icon: <Target className="w-6 h-6" strokeWidth={2} />,
          },
          {
            title: "Planning & Design",
            description:
              "Design solutions tailored to your needs with detailed planning and architecture",
            icon: <Code className="w-6 h-6" strokeWidth={2} />,
          },
          {
            title: "Development & Execution",
            description:
              "Build and implement solutions using agile methodology and best practices",
            icon: <Rocket className="w-6 h-6" strokeWidth={2} />,
          },
          {
            title: "Testing & Quality Assurance",
            description:
              "Comprehensive testing to ensure quality, performance, and reliability",
            icon: <CheckCircle className="w-6 h-6" strokeWidth={2} />,
          },
          {
            title: "Deployment & Launch",
            description:
              "Deploy solutions with zero downtime and comprehensive monitoring",
