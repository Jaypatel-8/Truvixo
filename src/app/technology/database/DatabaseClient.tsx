  ...
  return (
    <main className="min-h-screen bg-white overflow-hidden pt-20">
      ...
      <GetQuoteSection
        ...
        hollowText="Database Solutions?"
        description="Get in touch and let's discuss how we can help transform your data infrastructure with scalable database solutions."
        primaryCTA={{
          text: 'Call Us',
