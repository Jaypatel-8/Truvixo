...
import { mobileTechnologyData } from '@/lib/staticData/technology/mobile'
...
export default function FrontendClient({ faqs }: FrontendClientProps) {
  ...
  const technologies = mobileTechnologyData.technologies.map(tech => {
  ...
  const whatWeBuild = mobileTechnologyData.whatWeBuild.map(item => {
  ...
  const benefits = mobileTechnologyData.benefits.map(benefit => {
  ...
  const whyChooseUs = mobileTechnologyData.whyChooseUs.map(item => {
    const IconComponent = getIcon(item.iconName)
    return {
      ...item,
      icon: IconComponent ? <IconComponent className="w-6 h-6" /> : null
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="scroll-animate">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              {mobileTechnologyData.cta.title}
            </h2>
            <button
            ...
            >
              {mobileTechnologyData.cta.buttonText}
