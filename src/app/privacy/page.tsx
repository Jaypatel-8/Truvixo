...
export const metadata: Metadata = {
  ...
  description:
    "TruVixoo Privacy Policy - Learn how we collect, use, and protect your personal information. Your privacy is important to us.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <section className="relative py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 scroll-animate">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              At TruVixo, we are committed to protecting your privacy and
            ...
            <div className="prose prose-lg max-w-none scroll-animate">
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  ...
                  <li>
                    To send you marketing communications, newsletters, and
                    promotional materials (with your consent)
                  </li>
                  <li>To process transactions and manage your account</li>
                  <li>
                    To analyze website usage and trends to improve user
                    experience
                  </li>
                  <li>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  and store information about your preferences and browsing
                  behavior. You can control cookie preferences through your
                  browser settings. However, disabling cookies may limit your
              ...
              <div className="mb-12">
                ...
                <div className="bg-gray-50 rounded-xl p-6 mt-6">
                  <p className="text-gray-700 mb-2">
                    <strong>Email:</strong>{" "}
                    <a
                      href="mailto:privacy@truvixoo.com"
                      className="text-[#5e2cb6] hover:underline"
                    >
                      privacy@truvixoo.com
                    </a>
                  </p>
                  <p className="text-gray-700 mb-2">
                    <strong>Phone:</strong>{" "}
