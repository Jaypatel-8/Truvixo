          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="scroll-animate">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-gray-900 mb-6 leading-tight">
                Our <span className="hollow-text-brand block mt-2">Work</span>
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed">
                Explore how TruVixoo helps businesses innovate through
                technology and creativity. Discover our portfolio of successful
                projects that demonstrate our ability to deliver exceptional
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 scroll-animate">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Discover how our projects deliver measurable value and transform
              businesses
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 card-grid-direction">
            {benefits.map((benefit, index) => (
              <div
                ...
                style={{ ["--card-accent" as string]: benefit.color }}
              >
                <div className="card-inner-reveal">
                  <div
                    className="card-icon w-12 h-12 rounded-lg flex items-center justify-center mb-4"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="scroll-animate">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 leading-tight">
              Ready to Start Your{" "}
              <span className="hollow-text-white">Project?</span>
            </h2>
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto mb-10 font-light">
              Get in touch and let's discuss how we can help transform your
