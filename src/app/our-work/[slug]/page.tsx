...
export async function generateMetadata({
  ...
  const projectNames: Record<string, string> = {
    ...
    "brightedge-healthcare-analytics":
      "BrightEdge Healthcare Analytics - AI-Powered Solution",
    "urbanmint-property-platform":
      "UrbanMint Property Platform - Real Estate Management",
    "padmavat-construction-management":
      "Padmavat Construction Management - Project Management Solution",
  };
