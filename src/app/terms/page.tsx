...
export const metadata: Metadata = {
  ...
  description:
    "TruVixoo Terms and Conditions - Read our terms of service, user agreements, and legal policies governing the use of our website and services.",
  robots: {
    index: true,
    follow: true,
  },
        ...
        <section className="relative py-20 bg-gradient-to-b from-gray-50 to-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 scroll-animate">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              ...
              TruVixoo website and services. By accessing or using our services,
            ...
            <div className="prose prose-lg max-w-none scroll-animate">
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  By accessing and using the TruVixoo website and services, you
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  TruVixo's website for personal, non-commercial transitory
                ...
                <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 ml-4">
                  ...
                  <li>
                    ...
                    contained on TruVixo's website
                  </li>
                  <li>
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  of these restrictions and may be terminated by TruVixoo at any
                  time.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  TruVixoo provides AI-powered branding, marketing, and
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  functionality are owned by TruVixoo and are protected by
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  or other material. You are responsible for the content that
                  you post on or through the service.
                </p>
                <p className="text-gray-700 mb-4 leading-relaxed">
                  By posting content, you grant TruVixoo a worldwide,
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  All fees for services are as specified in your service
                  agreement or proposal. Payment terms will be outlined in your
                  specific contract. We reserve the right to change our pricing
                  at any time, but changes will not affect existing contracts.
                </p>
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Late payments may result in suspension or termination of
                  services. All fees are non-refundable unless otherwise
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  In no event shall TruVixo, nor its directors, employees,
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  basis. To the fullest extent permitted by law, TruVixo
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  You agree to defend, indemnify, and hold harmless TruVixoo and
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 mb-4 leading-relaxed">
                  ...
                  the jurisdiction in which TruVixoo operates, without regard to
              ...
              <div className="mb-12">
                ...
                <div className="bg-gray-50 rounded-xl p-6 mt-6">
                  <p className="text-gray-700 mb-2">
                    <strong>Email:</strong>{" "}
                    <a
                      href="mailto:legal@truvixoo.com"
