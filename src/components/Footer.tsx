...
const FOOTER_LINK_CLASS =
  "text-sm text-gray-600 dark:text-white hover:bg-[#5e2cb6]/10 hover:text-[#5e2cb6] dark:hover:bg-transparent dark:hover:text-white transition-colors duration-300 block rounded px-1 py-0.5 -mx-1 capitalize";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 dark:gap-6 lg:gap-12 dark:lg:gap-8 mb-10 dark:mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-600 dark:text-white mb-6 text-sm leading-relaxed">
              AI-powered branding, marketing, and technology company helping
              businesses scale from concept to market leader.
            </p>
            ...
            <div className="space-y-3 mb-6">
              ...
              >
                <div
                  className="w-10 h-10 rounded-lg flex items-center justify-center transition-colors"
                  style={{ backgroundColor: "rgba(234, 67, 53, 0.12)" }}
                >
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                aria-label="Visit TruVixoo on LinkedIn"
              >
              ...
              <a
                ...
                aria-label="Visit TruVixoo on Instagram"
              >
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-xs font-semibold text-gray-700 dark:text-white mb-2.5 uppercase">
                  AI & Machine Learning
                </h4>
                <ul className="space-y-2.5">
              ...
              <div>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2.5 uppercase tracking-wide">
                  Digital Marketing
                </h4>
                <ul className="space-y-2.5">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              <Link
                href="/privacy"
                prefetch={true}
                className="text-gray-600 dark:text-white hover:text-black dark:hover:text-white transition-colors duration-300"
              >
                Privacy Policy
              </Link>
              <Link
